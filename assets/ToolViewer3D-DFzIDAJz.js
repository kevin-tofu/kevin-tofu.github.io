...
`)}function px(s,e){let t;switch(e){case gu:t="Linear";break;case _u:t="Reinhard";break;case vu:t="Cineon";break;case Ec:t="ACESFilmic";break;case bu:t="AgX";break;case yu:t="Neutral";break;case Mu:t="Custom";break;default:be("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ar=new D;function mx(){$e.getLuminanceCoefficients(ar);const s=ar.x.toFixed(4),e=ar.y.toFixed(4),t=ar.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
